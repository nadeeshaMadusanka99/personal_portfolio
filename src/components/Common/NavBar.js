    ...
    <AnimatePresence mode="wait">
      ...
      >
        ...
        <header className="w-full px-32 py-8 font-medium flex items-center  justify-between dark:text-light relative lg:px-16 md:px-12 sm:px-8 sm:pb-4">
          <button
            className=" flex-col justify-center items-center hidden lg:flex fixed top-0 z-10 bg-light mt-5 rounded-full px-3 py-5 dark:bg-dark dark:text-light"
              ...
              <nav className="flex items-center justify-center flex-wrap mt-5">
                ...
                >
                  {mode === "dark" ? (
                    ...
                    <MoonIcon className={"fill-dark lg:w-6 lg:h-6"} />
                  )}
                </button>
              </nav>
            </motion.div>
